                            ...
                            <div class="box-body">
                                ...
                                <div class="col-md-offset-3 col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea  name="short_description" name="description" id="editor" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">
