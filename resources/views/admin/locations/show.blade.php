        ...
        <section class="content">
            ...
            <div class="box">
                <div class="box-header">
                    <a href="{{ route('locations.create') }}" class="btn btn-info"><span class="fa fa-plus"></span> Add new</a>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            @foreach($locations as $location)
                                <tr>
                                    ...
                                    <td>{{ $location->name }}</td>
                                    <td>
                                        <a data-toggle="tooltip" data-placement="bottom" title="Edit" href="{{ route('locations.edit',$location->id) }}" class="badge bg-light-blue " disabled><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
