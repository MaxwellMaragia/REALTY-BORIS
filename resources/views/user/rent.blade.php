                        ...
                        <div class="grid_list_search_result">
                            <div class="col-sm-12 col-md-4 col-lg-4 col-xl-5">
                                <div class="left_area tac-xsd">
                                    <p>{{ $properties->count() }} Properties for rent</p>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="feat_property list">
                                <div class="thumb">
                                    <img class="img-whp" src="{{ Storage::url($property->image) }}" alt="{{ $property->name }}">
                                </div>
                                <div class="details">
                                    <div class="tc_content">
                                        <div class="dtls_headr">
                                            <ul class="tag">
                                                <li class="list-inline-item"><a>{{ $property->Property_status }}</a></li>
                                            ...
                                            <a class="fp_price"><small>{{ $property->price }}</small></a>
                                        </div>
                                        <p class="text-thm">Apartment</p>
                                        <h4>{{ $property->name }}</h4>
                                        <p><span class="flaticon-placeholder"></span>{{ $property->location }}</p>
                                        <ul class="prop_details mb0">
                                            <li class="list-inline-item"><a>Bedrooms: {{ $property->bedroom }}</a></li>
                                            <li class="list-inline-item"><a>Bathrooms: {{ $property->bathroom }}</a></li>
                                            <li class="list-inline-item"><a>{{ $property->size }}</a></li>
                                        </ul>
                                    </div>
                                    <div class="fp_footer">
                                        <div class="fp_pdate float-right">{{ date('Y', strtotime($property->date_built)) }}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
